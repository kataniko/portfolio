...
export default function Svg () {
    ...
    return (
        <motion.svg initial={{ z: 0, opacity: 0, scale: 0.9 }}
            animate={{ x: 0, opacity: 1, scale: 1, }}
            transition={{ duration: 1.4, }} id="svgcontent" className="svg-drawing absolute z-10 mt-251 ml-335" width="993" height="849" viewBox="0 0 993 849" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path ref={lineRef}
                fill="none"
                stroke="#222222"
                strokeWidth="2"
